...
$(LIB_DIR)/rubiks-cube.a : $(OBJ_DIR)/common.o $(OBJ_DIR)/position.o $(OBJ_DIR)/facelet.o $(OBJ_DIR)/cubelet.o $(OBJ_DIR)/cube.o $(OBJ_DIR)/main.o
	@mkdir -p $(OBJ_DIR)
	$(AR) $(ARFLAGS) $@ $^
...
$(BIN_DIR)/%_unittest :  $(OBJ_DIR)/%_unittest.o $(LIB_DIR)/rubiks-cube.a  $(LIB_DIR)/gtest.a
	@mkdir -p $(BIN_DIR)
